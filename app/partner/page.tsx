  ...
  return (
    <div className="bg-white">
      ...
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-10 sm:pb-14">
        <div className="inline-flex items-center gap-2 bg-[#007AFF]/8 text-[#007AFF] px-3 py-1 rounded-sm text-[11px] font-semibold tracking-[0.08em] uppercase mb-5 sm:mb-6">
        ...
        <h1 className="text-[32px] sm:text-[46px] lg:text-[54px] font-medium text-black tracking-tight leading-[1.05] mb-4 sm:mb-5 max-w-[700px]">
          ...
          <span className="text-[#007AFF]">a software marketplace.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
          <Link
            href="#contact"
            className="flex items-center justify-center gap-2 bg-[#007AFF] text-white px-6 py-3 sm:py-2.5 text-[14px] font-medium rounded-sm hover:bg-[#0051D5] transition-colors min-h-[44px]"
          >
            Talk to us <ArrowRight size={15} strokeWidth={2} />
          </Link>
          <Link
            href="#how-it-works"
            className="flex items-center justify-center gap-2 text-[14px] text-black border border-black/10 px-5 py-3 sm:py-2.5 hover:bg-[#f5f5f7] bg-white rounded-sm font-medium transition-colors min-h-[44px]"
          >
        ...
        <div className="mt-8 sm:mt-12 pt-8 sm:pt-10 border-t border-black/8">
          <p className="text-[11px] font-semibold text-[#86868b] tracking-[0.1em] uppercase mb-3 sm:mb-4">Trusted by leading platforms</p>
      ...
      <section id="how-it-works" className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-20">
        <div className="mb-8 sm:mb-12">
          <p className="text-[11px] font-semibold text-[#86868b] tracking-[0.1em] uppercase mb-2">Three Partnership Models</p>
      ...
      {/* ── BUNDLE EXAMPLES ── */}
      <section className="bg-[#f5f5f7] border-y border-black/5 py-10 sm:py-16">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="flex items-end justify-between mb-8 flex-wrap gap-4">
            <div>
              <p className="text-[11px] font-semibold text-[#86868b] tracking-[0.1em] uppercase mb-1.5">Bundle Builder in Action</p>
              <h2 className="text-[26px] font-semibold text-black tracking-tight">Pre-built packages your customers love</h2>
            </div>
            <Link href="/products" className="flex items-center gap-1 text-[12px] font-semibold text-[#007AFF] hover:text-[#0051D5] transition-colors shrink-0">
            ...
            {bundleExamples.map(bundle => (
              <div key={bundle.name} className="bg-white border border-black/8 rounded-sm p-5">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <span className="text-[10px] font-semibold text-[#86868b] uppercase tracking-[0.08em]">{bundle.category}</span>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-black/8">
                  <div>
                    ...
                    <p className="text-[10px] text-[#86868b]">billed monthly</p>
                  </div>
                  <Link href="#contact" className="text-[12px] font-semibold text-[#007AFF] hover:text-[#0051D5] flex items-center gap-1 transition-colors">
          ...
          <p className="text-center text-[12px] text-[#86868b] mt-6 flex items-center justify-center gap-1.5">
      ...
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-20">
        <div className="mb-10">
          <p className="text-[11px] font-semibold text-[#86868b] tracking-[0.1em] uppercase mb-2">Simple Deployment</p>
          ...
          {[
            ...
            <div key={step} className="border border-black/8 rounded-sm p-5 bg-white">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-[11px] font-bold text-[#86868b] tracking-[0.1em] uppercase">Step {step}</span>
              </div>
              <h3 className="text-[14px] font-semibold text-black mb-1.5">{title}</h3>
              <p className="text-[12px] text-[#86868b] leading-[1.65]">{body}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-[#f5f5f7] border-y border-black/5 py-10 sm:py-16">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="mb-8">
            <p className="text-[11px] font-semibold text-[#86868b] tracking-[0.1em] uppercase mb-2">Ideal Partners</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              <div key={name} className="bg-white border border-black/8 rounded-sm p-5">
                <div className="w-9 h-9 rounded-sm bg-[#f5f5f7] border border-black/8 flex items-center justify-center text-black mb-3">{icon}</div>
                <h3 className="text-[14px] font-semibold text-black mb-1.5">{name}</h3>
                <p className="text-[12px] text-[#86868b] leading-[1.65]">{desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 py-12 sm:py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div>
            <p className="text-[11px] font-semibold text-[#86868b] tracking-[0.1em] uppercase mb-2">Revenue Model</p>
          ...
          <div className="bg-[#f5f5f7] border border-black/8 rounded-sm p-6">
            <p className="text-[12px] font-semibold text-[#86868b] uppercase tracking-[0.08em] mb-4">Example Revenue Scenario</p>
            <div className="space-y-3">
              {[
                ...
                <div key={label} className={`flex items-center justify-between py-2.5 px-3 rounded-sm ${highlight ? 'bg-[#007AFF] text-white' : 'bg-white border border-black/8'}`}>
            ...
            <p className="text-[10px] text-[#86868b] mt-3">* Illustrative figures. Actual margins vary by category and agreement.</p>
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="bg-black py-10 sm:py-16">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div>
              <p className="text-[11px] font-semibold text-[#86868b] tracking-[0.1em] uppercase mb-3">Get in Touch</p>
            ...
            <form className="bg-white rounded-sm p-6 space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[11px] font-semibold text-[#86868b] uppercase tracking-[0.08em] mb-1.5">First Name</label>
                  <input
                    type="text"
                    placeholder="Ravi"
                    className="w-full bg-[#f5f5f7] border-0 px-3 py-2.5 text-[13px] text-black placeholder-[#bbb] rounded-sm outline-none focus:ring-2 focus:ring-[#007AFF]/20 focus:bg-white transition-colors min-h-[44px]"
                  />
                </div>
                <div>
                  <label className="block text-[11px] font-semibold text-[#86868b] uppercase tracking-[0.08em] mb-1.5">Last Name</label>
                  <input
                    type="text"
                    placeholder="Sharma"
                    className="w-full bg-[#f5f5f7] border-0 px-3 py-2.5 text-[13px] text-black placeholder-[#bbb] rounded-sm outline-none focus:ring-2 focus:ring-[#007AFF]/20 focus:bg-white transition-colors min-h-[44px]"
              ...
              <div>
                <label className="block text-[11px] font-semibold text-[#86868b] uppercase tracking-[0.08em] mb-1.5">Work Email</label>
                <input
                  type="email"
              ...
              <div>
                <label className="block text-[11px] font-semibold text-[#86868b] uppercase tracking-[0.08em] mb-1.5">Company</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-[11px] font-semibold text-[#86868b] uppercase tracking-[0.08em] mb-1.5">Partnership Model</label>
                <select className="w-full bg-[#f5f5f7] border-0 px-3 py-2.5 text-[13px] text-black rounded-sm outline-none focus:ring-2 focus:ring-[#007AFF]/20 focus:bg-white transition-colors min-h-[44px]">
              ...
              <div>
                <label className="block text-[11px] font-semibold text-[#86868b] uppercase tracking-[0.08em] mb-1.5">Message (optional)</label>
                <textarea
                  rows={3}
                  placeholder="Tell us about your platform and customer base..."
                  className="w-full bg-[#f5f5f7] border-0 px-3 py-2 text-[13px] text-black placeholder-[#bbb] rounded-sm outline-none focus:ring-2 focus:ring-[#007AFF]/20 focus:bg-white transition-colors resize-none"
                />
              </div>
              <button
                type="submit"
                className="w-full bg-[#007AFF] text-white py-3 text-[14px] font-semibold rounded-sm hover:bg-[#0051D5] transition-colors flex items-center justify-center gap-2 min-h-[44px]"
              >
                Submit Enquiry <ArrowRight size={15} strokeWidth={2} />
              </button>
              <p className="text-center text-[10px] text-[#86868b]">We do not share your details with any third party.</p>
            </form>
          </div>
        </div>
      </section>
...
function TierOneVisual({ items, accent }: { items: string[]; accent: string }) {
  return (
    <div className="space-y-2.5">
      <p className="text-[11px] font-semibold text-[#86868b] uppercase tracking-[0.08em] mb-3">Your branded domains</p>
      {items.map((domain, i) => (
      ...
      <div className="mt-3 pt-3 border-t border-black/10">
        <p className="text-[11px] text-[#86868b]">Powered by <span className="font-semibold text-black">Zoftware Engine</span></p>
      </div>
    </div>
  );
}
...
function TierTwoVisual({ accent }: { accent: string }) {
  return (
    <div>
      <p className="text-[11px] font-semibold text-[#86868b] uppercase tracking-[0.08em] mb-3">Inside your existing app</p>
        ...
        <div className="p-3 grid grid-cols-4 gap-2">
          {['Payments', 'Loans', 'Insurance', 'Analytics', 'Payroll', 'Invoices', 'Inventory'].map(item => (
            <div key={item} className="flex flex-col items-center gap-1">
              <div className="w-10 h-10 rounded-sm bg-[#f5f5f7] border border-black/8 flex items-center justify-center">
                <div className="w-3 h-3 rounded-sm bg-[#ccc]" />
              </div>
              <span className="text-[8px] text-[#86868b] text-center leading-tight">{item}</span>
            </div>
          ))}
...
function TierThreeVisual({ accent }: { accent: string }) {
  return (
    <div>
      <p className="text-[11px] font-semibold text-[#86868b] uppercase tracking-[0.08em] mb-3">Bundle preview</p>
        ...
        <div className="p-3 space-y-2">
          {[
            ...
            <div key={label} className="flex items-center gap-2 text-[11px]">
              ...
              <span className="text-[#86868b] text-[9px] bg-[#f5f5f7] px-1.5 py-0.5 rounded-sm">{type}</span>
            </div>
          ))}
        </div>
